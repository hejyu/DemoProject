 ...
 <link rel="stylesheet" href="css/layout.css" />
  ...
  <link rel="stylesheet" href="css/join.css" /> 
    <script>
     ...
     /* sms.jsp 에서 인증에 성공하면 보낸 메시지 message  를 받는 이벤트입니다. */
 ...
 */
        ...
        if(!isChecked) {
          ...
          return;
        }	// isChecked 가 참일 때 중복검사했던 아이디와 현재 username의 값이 같은지 비교 필요합니다
      ...
      function checkId() {
        ...
        // form 태그 안에 모든 요소 값을 자바스크립트 객체로  변환합니다.
        const data = $('#form').serializeObject();
		...
		/*  비동기 통신을 위한 jquery (순수 자바스크립트 의 XMLHttpRequest 를 쉽게 사용하도록 합니다) */
        $.ajax({
        ...
        /*   contentType: 'application/json', */
          success : function(res){		// 요청에 성공하고 받은 응답을 res 변수로 받습니다
